...
const HeroSection = (props) => {
  return (
    <>
        <section className="relative top-20 w-screen h-screen z-0 bg-slate-100 p-1 bg-background-girl bg-contain bg-no-repeat bg-right flex justify-center items-start flex-col px-24 max-sm:px-10 max-sm:bg-[13px] 2xl:px-36 max-sm:bg-cover">
